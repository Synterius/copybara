...
* якщо у правила заміни порожнє поле **“На що замінити”**, під час копіювання текст залишається без змін.
...
* правила з порожнім полем **“На що замінити”** не змінюють текст під час копіювання;
* правило заміни можна застосувати безпосередньо до поточного файлу з підтвердженням і підрахунком кількості замін;
* після застосування правило автоматично видаляється, а наступні правила зсуваються вперед;
...
* `Ctrl + Shift + R` створює нове правило заміни з виділеного тексту без відкриття вікна правил;
* якщо перед `Ctrl + Shift + R` нічого не виділено, відкривається вікно керування правилами заміни.
...
| `Ctrl + Shift + R` | Створити нове правило заміни з виділеного тексту або відкрити вікно правил |
| `Ctrl + +`         | Відкрити вікно додавання команди                                    |
| `Ctrl + Shift + +` | Створити новий файл                                                 |
| `Ctrl + Enter`     | Додати команду з відкритого діалогу                                 |

> Якщо перед `Ctrl + F`, `Ctrl + R` або `Ctrl + Shift + R` виділено текст, Copybara автоматично використає його для відповідної дії.
...
## Що нового в Copybara 2.1.1

Copybara 2.1.1 — реліз із покращеннями системи замін та швидшою роботою з правилами.

### Нове

* Додано `Ctrl + Shift + R` для створення нового правила заміни з виділеного тексту.
* Якщо текст не виділено, `Ctrl + Shift + R` відкриває вікно керування правилами заміни.
* Додано кнопку застосування правила заміни до поточного файлу.
* Перед застосуванням Copybara показує підтвердження з кількістю майбутніх замін.
* Кнопка застосування доступна як у швидкій панелі заміни, так і у вікні правил.

### Покращення UX

* Після застосування правило автоматично видаляється.
* Якщо застосоване перше правило, наступні правила зсуваються вперед.
* У вікні правил заміни поля введення коректно стискаються після додавання додаткової кнопки.
* Якщо поле **“На що замінити”** порожнє, під час копіювання текст більше не замінюється на порожнє значення.
